        ...
        switch (trimmed) {
            ...
            case "skills":
                response = [
                    ...
                    { type: "info", content: "-> Database: MongoDB, MySQL, Supabase" },
            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed inset-x-4 md:inset-x-auto md:w-[600px] md:left-1/2 md:-translate-x-1/2 top-24 z-[70] rounded-xl overflow-hidden border border-border/70 shadow-2xl bg-[#0d1117] font-mono text-sm md:text-base flex flex-col max-h-[70vh]"
                    >
                        {/* Header / Mac-style Title Bar */}
                        <div className="bg-[#161b22] px-4 py-3 flex items-center justify-between border-b border-border/40 select-none">
                            ...
                            <div className="text-muted text-xs font-semibold tracking-wider">
                                guest@shalini-os:~
                            </div>
                        ...
                        {/* Terminal Body */}
                        <div
                            className="p-4 flex-1 overflow-y-auto text-gray-300"
