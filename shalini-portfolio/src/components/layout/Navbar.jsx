          ...
          <div className="flex items-center gap-6">
            ...
            <div className="hidden md:flex items-center gap-2">
              <button
                ...
                className="p-2 rounded-full hover:bg-accent/10 transition-colors text-muted hover:text-foreground text-sm flex items-center gap-1"
                aria-label="Toggle snow effect"
              >
                <span className="text-[16px]">{isSnowing ? '❄️' : '☁️'}</span>
              </button>
              <button
                onClick={() => setIsTerminalOpen(true)}
                className="px-3 py-1.5 rounded-md hover:bg-accent/10 transition-colors text-muted hover:text-foreground font-mono text-xs border border-border/70 flex items-center gap-2"
                aria-label="Open Terminal"
              >
                <span className="text-accent">&gt;_</span> CLI
              </button>
          ...
          {isOpen && (
            ...
            >
              <div className="px-6 py-6 pb-8 flex flex-col gap-6 max-h-[calc(100vh-4rem)] overflow-y-auto">
                ...
                <motion.div
                  className="pt-4 flex flex-col gap-4 border-t border-border/50"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                ...
                >
                  <div className="flex items-center justify-between text-sm font-medium text-muted">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 rounded-md bg-accent/10 text-accent font-mono text-xs border border-accent/20"
                    >
                      &gt;_ OPEN
                    </button>
                  </div>
